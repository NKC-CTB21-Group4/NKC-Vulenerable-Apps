...
class ChallengesJwtService {
    protected $secretKey;
    protected $algorithm;
    private DatabaseChallengesAuthTokenRepository $authTokenRepository;

    public function __construct(DatabaseChallengesAuthTokenRepository $authTokenRepository) {
    ...
    public function generateToken(array $payload): string {
        ...
        $this->authTokenRepository->save(new ChallengesAuthToken($token,$payload['exp']));
        return $token;
    }
