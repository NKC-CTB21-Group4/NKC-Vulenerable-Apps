...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $responsePost = $diaryAPI->sendPostRequest('', $data);
    // 結果の表示
    if ($responsePost) {
        $_SESSION['message'] = "日記が正常に作成されました。";
    } else {
        $_SESSION['message'] = "日記が作成されませんでした";
    }
}
?>
...
<?php echo generate_header() ?>
    <div class="form-container diary-form-container">
